...
struct WishListView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                switch selectedTab {
                case 0:
                    GridCardsView(collection: collection, viewType: "wish", cards: $cards) { card in
    ...
    func prepareCards() {
        cards = []
        cards = Array(DataBaseManager.shared.getWishList(from: collection))
    }
}


#Preview {
    WishListView(collection: DataBaseManager.shared.MOCK())
}
